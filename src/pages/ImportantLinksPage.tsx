...
export const ImportantLinksPage: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
      {/* Banner */}
      <div className="bg-indigo-950 text-white rounded-2xl p-6 sm:p-8 shadow-sm border-2 border-indigo-400/50 space-y-2">
        <div className="flex items-center gap-2 text-amber-300 font-bold text-xs uppercase tracking-wider">
          <ShieldCheck className="w-4 h-4" />
          <span>Official Commission & Testing Authority Directory</span>
        </div>
        <h1 className="text-2xl sm:text-3xl font-black font-serif">Important Useful Government Links</h1>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
          <div className="relative w-full sm:w-80">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-2 text-xs sm:text-sm rounded-lg border border-slate-300 focus:outline-hidden focus:ring-2 focus:ring-indigo-600 font-medium"
            />
          </div>
          ...
          >
            ...
            <div className="pt-4 mt-4 border-t border-slate-100 flex items-center justify-between">
              ...
              <a
                ...
                className="bg-indigo-900 hover:bg-indigo-800 text-white text-xs font-bold px-3.5 py-1.5 rounded-lg flex items-center gap-1.5 transition shadow-2xs"
              >
